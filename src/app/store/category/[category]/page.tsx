...
> = {
  vault: {
    ...
    pillarContent: [
      'The Vault is the complete Dead Hidden library — every guide, manual, protocol, and framework Adam Johnsson has ever created, bundled together for the man who refuses to go into battle unarmed.',
  ...
  women: {
    ...
    pillarContent: [
      ...
      'Dead Hidden exists primarily for men — but the women who stand beside those men need truth too. Christie Johnsson runs Biblical Womanhood because she understands that the crisis of masculinity and the crisis of femininity are the same crisis. You cannot fix one without addressing the other.',
      'The resources in this category are not soft. They are not wrapped in pastel colors with encouraging quotes. They are direct, biblical, and unapologetic — because the women reading them have already had enough of the watered-down version.',
