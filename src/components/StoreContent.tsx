...
export function StoreContent({ initialCategory }: StoreContentProps) {
  ...
  const handleCategoryChange = (category: Category | undefined) => {
    ...
    trackConversion('store_category_filter', {
      category: category || 'all',
      location: 'store_archive',
    });
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-3 overflow-x-auto pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {categoryList.map((cat) => {
              ...
              return (
                <button
                  key={cat}
                  onClick={() => handleCategoryChange(isAll ? undefined : (cat as Category))}
        ...
        <p className="text-sm text-[#888] mb-8">
          ...
          <Link
            ...
            onClick={() => trackConversion('product_card_click', {
              product: 'counterfeit-kingdom-starter-guide',
              location: 'store_starter_callout',
              price: 17,
            })}
            className="text-[#8b0000] hover:text-[#e8e0d0] transition-colors font-bold"
          >
          ...
          {displayedProducts.map((product) => (
            <Link
              ...
              onClick={() => trackConversion('product_card_click', {
                ...
                location: 'store_archive',
                price: numericPrice(product.priceLabel),
            ...
            {(Object.keys(CATEGORIES) as Category[]).map((cat) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => trackConversion('store_category_click', {
                    category: cat,
                    location: 'store_archive_bottom',
                  })}
