...
export const products: Product[] = [
  ...
  {
    slug: "the-dog-at-the-kings-table",
    name: "THE DOG AT THE KING'S TABLE",
    tagline: "A 7-day field manual for the broken Christian man. Built on Mephibosheth and the Canaanite woman. Both called themselves dogs. Both got fed.",
    seoKeywords: [
      "Christian devotional for broken men",
      "Mephibosheth devotional",
      "Canaanite woman devotional",
      "KJV daily devotional men",
      "biblical masculinity devotional",
      "7 day Christian guide",
      "Christian field manual",
      "devotional for spiritually broken Christian men",
    ],
    description: "Mephibosheth was a crippled grandson hiding in a town called Lo-debar. No pasture. No future. No reason to expect anything from the King except an executioner. The Canaanite woman fell at Christ's feet and agreed she was a dog. Both got the table. Seven mornings. Seven KJV passages. Seven small actions you can do at your kitchen table before the kids wake up. Built for the man who finally stopped pretending he had something to bring the King except a mouth.",
    priceCents: 700,
    priceLabel: "$7",
    ...
    purchaseType: "stripe",
    legacyGumroadSlug: "",
    ctaText: "OPEN THE TABLE →",
    coverImage: "/product-files/product-cover-the-dog-at-the-kings-table.jpg",
    comparisonLine: "Most Christian devotionals cost $15-$29 and read like Hallmark cards. This one was written from the floor by a man who calls himself a dog and means it. $7. Seven mornings. KJV only.",
    extendedContent: {
      whoIsThisFor: [
      ...
      longDescription: "I am going to be plain with you on the front porch.\n\nThis is not a guide written by a teacher.\n\nIt is a guide written by a dog.\n\nI am not a pastor. I am not the smartest brother in your group chat. I have been in the gutter most of my life and I will tell you on page one that the ground I am writing from is the floor. What I have learned down there is the only thing this manual exists to pass to you.\n\nTwo Bible characters figured something out the rest of us spend our whole lives trying to argue our way around. The Canaanite woman. Mephibosheth. She agreed she was a dog. He called himself a dead dog. Neither of them flinched. Neither of them tried to negotiate.\n\nBoth of them got fed.\n\nMost Christian men are still arguing with the King about whether they are dogs. The seven mornings inside this manual will get you to stop arguing. Not because the King wants you to grovel. Because the table is already set, and you have been crawling around looking for a back door that does not exist.\n\nThe dog under the table is the man who finally got fed.",
      socialProof: "Built on the Substack post that drew 113 reactions and 46 reader comments — the highest engagement of any solo post in the last 30 days at The Biblical Man.",
      faq: [
        { q: "Is this just another devotional?", a: "No. Most devotionals tell you who you are supposed to become. This one names what you already are. A dog under the King's table. The table is already set. Seven mornings. KJV anchored. Two action items per day, both small enough to actually do." },
        { q: "Do I have to do all seven days in seven days?", a: "No. The point is the table, not the trophy. Read it as you can. The Word does not run on a stopwatch." },
        { q: "Why $7?", a: "Because the deeper work is at the Vault, and this is the front door of the inside. The Romans Guide is the free door on the porch. This is the first room you walk into. $7 is the cost of standing up." },
        { q: "Is this for men only?", a: "Written from one broken man to other broken men. But the Canaanite woman is in here, and she is the model. Wives have read it and forwarded it. The household is welcome." },
        { q: "What format?", a: "Digital PDF, instant delivery to your inbox the moment you check out. Print-friendly, fold-friendly, write-in-the-margins-friendly." },
        { q: "Refund?", a: "If you read it and got nothing, write me. I will send the seven dollars back. The work is the point. Not the receipt." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    name: "FAMILIAR SPIRITS: A FIELD MANUAL FOR BREAKING THE CONTRACTS YOUR FATHERS SIGNED",
    tagline: "The Bible you're reading erased the word for what's eating your family.",
    seoKeywords: ["familiar spirits KJV", "generational curses bible", "bloodline prayer protocol", "witch of endor meaning", "breaking generational demons", "spiritual warfare field manual", "deliverance from familiar spirits"],
    description: "PREORDER \u2014 Verse by verse through all 17 KJV passages on familiar spirits. Names the specific doors each one identifies, maps generational transmission across David, Saul, Manasseh, Josiah, and Ahab, and gives the full bloodline severance protocol. Preorder price locked until release.",
    priceCents: 2500,
    priceLabel: "$25",
    ...
    extendedContent: {
      whoIsThisFor: [
        "the man who watched his father carry the same shame he is carrying and knows the pattern did not start with either of them",
        "the believer who has been told generational curses are not biblical by a pastor using a translation that deleted the word \"familiar spirit\" from the text",
        "the Christian who has done accountability, counseling, and repentance \u2014 and still feels a hand in the house that will not leave",
        "the husband or father who refuses to be the generation that hands the contract down to his wife and his children",
        "the new believer who has never been taught what the KJV actually says about what follows a bloodline",
      ],
      whatsInside: [
        "Verse by verse through all 17 KJV passages on familiar spirits \u2014 Leviticus, Deuteronomy, 1 Samuel, 2 Kings, 1 Chronicles, 2 Chronicles, Isaiah, Acts \u2014 with the specific doors each passage names",
        "The Witch of Endor mechanic explained: why 1 Samuel 28 is not about ghosts, and what the Hebrew word \"\u02bfov\" actually identifies",
        "Generational transmission mapped across five bloodlines \u2014 David, Saul, Manasseh, Josiah, Ahab \u2014 so you can see the pattern the text is showing you about your own",
        "The 7-day severance sequence: day by day Scripture, prayer, renunciation, and action steps that break the contract without theatrics",
        "Room-by-room house audit: what objects, media, inheritance items, and agreements give a familiar spirit legal ground in a household \u2014 and how to clear them scripturally",
        "Scripture arsenal for your wife and your children \u2014 because the enemy does not stop at the man who closed his own door",
        "Emergency response protocol: what to pray out loud the moment you sense the pattern trying to come back through another member of the house",
        "\"Regard not them that have familiar spirits, neither seek after wizards, to be defiled by them: I am the LORD your God\" (Leviticus 19:31) \u2014 the field manual trains you to obey that verse with names on every door it is standing behind",
      ],
      longDescription: "Your modern translation does not have the word familiar spirit in it. The KJV uses it seventeen times. Every one of those passages is describing something your pastor told you was a metaphor \u2014 and something your grandmother could have named without opening the book.\n\nThis is not a deliverance theater product. It is a field manual. It walks you through the text the way a man walks through his own house with the lights on \u2014 room by room, door by door, contract by contract. When you finish it, you will know what a familiar spirit actually is in Scripture, how it gains ground in a bloodline, how it transmits, and what the Bible commands you to do about it.\n\nThe price is locked at $25 through preorder. It ships the day it is finished. If you are the man in your line who is supposed to be the one this breaks on \u2014 this is the field manual built for that assignment.",
      socialProof: "Built from the same verse-by-verse KJV discipline that drives the Substack (25,500+ subscribers) and the Biblical Man library. First run is a preorder \u2014 the price holds until release.",
      faq: [
        { q: "Is this about generational curses?", a: "The Bible calls them iniquities visited to the third and fourth generation (Exodus 20:5, Exodus 34:7). The field manual uses the KJV's own language \u2014 familiar spirits, iniquity, and the bloodline \u2014 not the Pentecostal-circuit vocabulary. If you want deliverance theater, this is not that. If you want to know what the text actually says, this is exactly that." },
        { q: "Is this Charismatic or Pentecostal doctrine?", a: "No. It is KJV 1611. Every protocol cites chapter and verse. No tongues requirement, no slain-in-the-spirit moments, no holy laughter \u2014 just the text, the pattern, and the prayer you can pray over your own house tonight." },
        { q: "When does it ship?", a: "Preorder is live now. You will receive the field manual the day it is finished. Preorder price of $25 is locked until release \u2014 after launch it moves to full price." },
        { q: "I don't think I have anything generational. Is this still for me?", a: "Read Leviticus 19:31 and Deuteronomy 18:10-12 and ask the Holy Ghost. If those verses are commands, they are commands with an assumed enemy. The field manual names that enemy and the doors through which it has historically entered \u2014 including doors most Christians never think to close." },
        { q: "Is there anything for my wife and kids in here?", a: "Yes \u2014 there is a full Scripture arsenal section for your wife and for your children, and an emergency response protocol for the moment you sense the pattern trying to come back through another member of the house." },
      ],
    },
  },
  {
  ...
  {
    slug: "wars-and-rumors-of-wars",
    name: "WARS AND RUMORS OF WARS",
    tagline: "A comprehensive Bible study on Revelation and Daniel's 70th Week. Twelve chapters. Ninety-three pages. Built from the text up.",
    seoKeywords: ["revelation bible study kjv", "daniel 70th week study", "christian end times guide", "territorial spirits daniel 10", "rapture tribulation millennial kingdom kjv", "book of revelation study pdf"],
    description: "A comprehensive Bible study tracing Revelation, Daniel's 70th Week, the prophetic timeline, the Antichrist system, the second coming, and the millennial kingdom from the King James Bible. No headline-chasing. No prophecy slop. Just the text, handled with precision.",
    priceCents: 9700,
    priceLabel: "$97",
    category: "bible-study",
    isFeatured: false,
    ...
    ctaText: "GET THE FULL GUIDE →",
    comparisonLine: "Most prophecy content is free because it's shallow. This is a 93-page field guide built verse by verse so you can stop borrowing other men's charts and see the structure for yourself.",
    extendedContent: {
      whoIsThisFor: [
      ...
      whatsInside: [
        "12 chapters and 93 pages tracing Revelation and Daniel's 70th Week from the text up",
        ...
        "A Part 2 teaser covering the scope of Revelation and what comes after the thousand years",
      ],
      longDescription: "The war you keep watching on the news is not the real war. Scripture keeps pulling the curtain back higher than geopolitics, higher than headlines, higher than party narratives. Daniel 10, Revelation, and the prophets do not describe a random world stumbling through chaos. They describe structure. Hierarchy. Timing. A conflict in the unseen that keeps erupting into the seen.\n\nWars and Rumors of Wars was built for the man who is tired of borrowed charts and shallow prophecy talk. This guide walks through Daniel's 70th Week, the times of the Gentiles, the Antichrist system, the tribulation sequence, the second coming, and the millennial kingdom with the King James Bible open the whole way. No sensationalism. No clickbait. No pretending current events are the doctrine.\n\nChapter 5 became the early sample because it shows the spine of the whole argument: if Ephesians 6:12 is true, then nations are not merely political actors. Daniel prayed, God answered on day one, and the messenger was delayed in warfare for twenty-one days. That changes how you read the world. The rest of the guide keeps following that thread until the prophetic architecture is visible from beginning to end.",
      faq: [
        { q: "Is this sensational end-times speculation?", a: "No. The entire point of the guide is to get men out of headline theology and back into the text. Every chapter is built from Scripture first, with the King James Bible doing the heavy lifting." },
        { q: "What does it cover besides Revelation?", a: "Daniel's 70th Week, the times of the Gentiles, Daniel 10 and territorial spirits, the rapture doctrine, the tribulation sequence, the Antichrist profile, the mark system, the two witnesses, the second coming, and the millennial kingdom." },
        { q: "Is this beginner-friendly or only for prophecy nerds?", a: "If you can read your Bible and stay with an argument, you can work through this. It is thorough, but it is written to make the structure visible, not to show off how much jargon the author knows." },
        { q: "What format is it delivered in?", a: "Digital PDF. Buy once, download immediately, and keep it." },
      ],
    },
  },
